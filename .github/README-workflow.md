...
6. If, for some reason, you decided to cancel Release at this stage, just delete created `release` branch (and all tags on it) on remote. This will automatically cancel PR to `master` branch.
