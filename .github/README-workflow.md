...
6. If, for some reason, you decided to cancel Release at this stage, just delete created `release` branch on remote. This event will automatically cancel PR to `master` branch.
